...
def test_add_new_pet_with_valid_data(name='Vasya', animal_type='kot',
                                     age='5', pet_photo='img/кот.jpg'):
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Rada", "dog", "4", "img/dog.jpeg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
#
def test_add_pet_new_photo(pet_photo='img/dog.jpeg'):
